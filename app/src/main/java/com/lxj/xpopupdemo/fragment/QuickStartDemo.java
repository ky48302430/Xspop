...
import static com.lxj.xpopup.impl.TipPopupView.ERROR_TYPE;
import static com.lxj.xpopup.impl.TipPopupView.SUCCESS_TYPE;
import static com.lxj.xpopup.impl.TipPopupView.WARNING_TYPE;
...
public class QuickStartDemo extends BaseFragment implements View.OnClickListener {
    ...
    public void init(final View view) {
        view.findViewById(R.id.btnShowInfo).setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case  R.id.btnShowInfo:
                XPopup.get(getContext()).asTip(WARNING_TYPE,"我是标题","床前明月光，疑是地上霜；举头望明月，低头思故乡。",new OnConfirmListener(){
                    @Override
